...
setuptools.setup(
    ...
    description_long="""
    A tool for splitting german compound word into subwords, such as Autobahnraststätte --> Autobahn, Raststätte.
     Based on the thesis `Tuggener, Don (2016). Incremental Coreference Resolution for German.
